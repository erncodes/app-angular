...
export class CartService {
  ...
  products : Product[] = [
    ...
    //pizza
    {
      ...
      category : 'Pizzas',
      size : 'large',
      imageUrl : '../assets/pizza_images/BBQ-Chicken-Pizza.jpg',
      isInStock : true,
      isInPromo : false,
      leftInStock : 30,
      price : 115.99,
    ...
    },
    {
      ...
      category : 'Pizza',
      size : 'large',
      imageUrl : '../assets/pizza_images/Black-Olives-and-Pepperoni.jpg',
      isInStock : true,
      isInPromo : false,
      leftInStock : 30,
      price : 122.99,
    ...
    },
    {
      ...
      category : 'Pizzas',
      size : 'small',
      imageUrl : '../assets/pizza_images/Chicken-Sausage-Pizza-with-Onions-and-Peppers.jpg',
      isInStock : true,
      isInPromo : false,
      leftInStock : 30,
      price : 52.99,
    ...
    },
    {
      ...
      category : 'Pizzas',
      size : 'large',
      imageUrl : '../assets/pizza_images/Greek-Pizza.jpg',
      isInStock : true,
      isInPromo : false,
      leftInStock : 30,
      price : 95.99,
    ...
    },
    {
      ...
      category : 'Pizzas',
      size : 'large',
      imageUrl : '../assets/pizza_images/Grilled-Pizza-With-Red-Onions-and-Feta.jpg',
      isInStock : true,
      isInPromo : false,
      leftInStock : 30,
      price : 105.99,
    ...
    },
    {
      ...
      category : 'Pizzas',
      size : 'large',
      imageUrl : '../assets/pizza_images/Olive-Pizza-with-Red-Onions.jpg',
      isInStock : true,
      isInPromo : false,
      leftInStock : 30,
      price : 52.99,
    ...
    },
    {
      ...
      category : 'Pizzas',
      size : 'large',
      imageUrl : '../assets/pizza_images/Pepperoni-Pizza.jpg',
      isInStock : true,
      isInPromo : false,
      leftInStock : 30,
      price : 102.99,
    ...
    },
    {
      ...
      category : 'Pizzas',
      size : 'large',
      imageUrl : '../assets/pizza_images/Pizzas-avacados.jpg',
      isInStock : true,
      isInPromo : false,
      leftInStock : 30,
      price : 92.99,
    ...
    },
    {
      ...
      category : 'Pizzas',
      size : 'large',
      imageUrl : '../assets/pizza_images/Sausage-Pizza-with-BBQ-Sauce.jpg',
      isInStock : true,
      isInPromo : false,
      leftInStock : 30,
      price : 89.99,
    ...
    },
    {
      ...
      category : 'Pizzas',
      size : 'large',
      imageUrl : '../assets/pizza_images/Smoked-Sausage-Pizza.jpg',
      isInStock : true,
      isInPromo : false,
      leftInStock : 30,
      price : 95.99,
